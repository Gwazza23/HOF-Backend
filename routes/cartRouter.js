...
cartRouter.get("/:id", isAuthenticated, async (req, res) => {
  try {
...
cartRouter.post("/", async (req, res) => {
  ...
  if (quantity > productQuantity) {
    res
      .status(400)
      .send(
        "We're sorry, but the quantity you have selected exceeds the amount currently in stock. Please adjust your quantity or check back later."
      );
    return;
  }
